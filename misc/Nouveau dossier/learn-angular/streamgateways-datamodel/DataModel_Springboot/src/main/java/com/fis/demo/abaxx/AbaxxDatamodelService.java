...
@Service
public class AbaxxDatamodelService {

	@Autowired
	AbaxxRepository abaxxRepository;

	public List<ABAXX_DATAMODEL> getfullMapping() {
		return abaxxRepository.findAll();
	}

	public List<ABAXX_DatamodelSA_Full> getSAInternalfull() {
		return null;
	}

	public List<ABAXX_DatamodelSA_Client> getSAclient(Integer validation_model) {
		return abaxxRepository.getABAXX_SAclient(validation_model);
	}

	public List<ABAXX_DatamodelCV_Full> getCVInternalfull(Integer validation_model) {
		return abaxxRepository.getABAXX_CVFull(validation_model);
	}

	public List<ABAXX_DatamodelSA_Full> getSAInternalfull(Integer validation_model) {
		return abaxxRepository.getABAXX_SAFull(validation_model);
	}

	public List<ABAXX_DatamodelCV_Client> getCVclient(Integer validation_model) {
		return abaxxRepository.getABAXX_CVclient(validation_model);

	}

	public List<ABAXX_DatamodelFISCD_Full> getFISCDInternalfull(Integer validation_model) {
		return abaxxRepository.getABAXX_FISCDInternalfull(validation_model);

	}

	public List<ABAXX_DatamodelFISCD_Client> getFISCDclient() {
		return null;
	}

	public List<ABAXX_DatamodelFISCD_Client> getFISCDclient(Integer validation_model) {
		return abaxxRepository.getABAXX_FISCDclient(validation_model);

	}

	public void saveDataModel(ABAXX_DATAMODEL d) {
		abaxxRepository.save(d);
	}

	public Optional<ABAXX_DATAMODEL> findById(int id) {
		return abaxxRepository.findById(id);
	}

	public void deleteById(int modelId) {
		abaxxRepository.deleteById(modelId);
	}

	public void updatedDatmodelColumn(ABAXX_DATAMODEL original_obj, ABAXX_DATAMODEL new_dataModel_Table) {
