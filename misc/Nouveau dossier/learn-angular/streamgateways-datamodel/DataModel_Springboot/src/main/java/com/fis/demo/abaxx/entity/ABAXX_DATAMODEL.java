...
@Table
@DynamicUpdate
public class ABAXX_DATAMODEL {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "my_seq_gen_ABAXX")
	@SequenceGenerator(name = "my_seq_gen_ABAXX", sequenceName = "GEN_SEQUENCE_ABAXX", allocationSize = 1, initialValue = 334)
	...
	@Column(nullable = true)
	String FISCD_FUNCTIONAL_NAME;

	@Column(nullable = true)
	String FISCD_SCREEN_NAME;

	@Column(nullable = true)
	String FISCD_DESCRIPTION;

	@Column(nullable = true)
	String FISCD_DTO_ATTRIBUTE;
	...
	@Column(nullable = true)
	String CLIENT_AE_TAG;
	@Column(nullable = true)
	String CLIENT_AE_FIELD;
	@Column(nullable = true)
	String CLIENT_AE_DESCRIPTION;
	...
	public ABAXX_DATAMODEL() {

	}

	public ABAXX_DATAMODEL(String sGW_API_MODEL, String sGW_API_ATTRIBUTE, String sGW_API_TYPE,
			String sGW_API_ISMANDATORY, String sGW_API_FUNCT_DESC, String sGW_API_IMPL_DESC,
			String sGW_API_INTERNAL_FLEXI, String fISCD_FUNCTIONAL_NAME, String fISCD_SCREEN_NAME,
			String fISCD_DESCRIPTION, String fISCD_DTO_ATTRIBUTE, String fISCD_FORMAT, String fISCD_TYPE,
			String fISCD_ISMANDATORY, String cV_CURRENT_CONSTRAINTS, String cV_FIX_RULES, String cV_CV_AUDIT,
			...
			Integer mAP_FILTER_MODEL, String cLIENT_AE_TAG, String cLIENT_AE_FIELD, String cLIENT_AE_DESCRIPTION,
			Integer mAP_ROW_TYPE) {
		super();
		...
		FISCD_FUNCTIONAL_NAME = fISCD_FUNCTIONAL_NAME;
		FISCD_SCREEN_NAME = fISCD_SCREEN_NAME;
		FISCD_DESCRIPTION = fISCD_DESCRIPTION;
		FISCD_DTO_ATTRIBUTE = fISCD_DTO_ATTRIBUTE;
		FISCD_FORMAT = fISCD_FORMAT;
		FISCD_TYPE = fISCD_TYPE;
		FISCD_ISMANDATORY = fISCD_ISMANDATORY;
		...
		CLIENT_AE_TAG = cLIENT_AE_TAG;
		CLIENT_AE_FIELD = cLIENT_AE_FIELD;
		CLIENT_AE_DESCRIPTION = cLIENT_AE_DESCRIPTION;
	}
	...
	public String getFISCD_ISMANDATORY() {
		return FISCD_ISMANDATORY;
	}

	public void setFISCD_ISMANDATORY(String fISCD_ISMANDATORY) {
		FISCD_ISMANDATORY = fISCD_ISMANDATORY;
	}
	...
	public void setFISCD_TYPE(String fISCD_TYPE) {
		FISCD_TYPE = fISCD_TYPE;
	}

	@JsonProperty("FISCD_DTO_ATTRIBUTE")
	public String getFISCD_DTO_ATTRIBUTE() {
		return FISCD_DTO_ATTRIBUTE;
	}

	public void setFISCD_DTO_ATTRIBUTE(String fISCD_DTO_ATTRIBUTE) {
		FISCD_DTO_ATTRIBUTE = fISCD_DTO_ATTRIBUTE;
	}
	...
	public void setFISCD_FORMAT(String fISCD_FORMAT) {
		FISCD_FORMAT = fISCD_FORMAT;
	}

	@JsonProperty("FISCD_DESCRIPTION")
	public String getFISCD_DESCRIPTION() {
		return FISCD_DESCRIPTION;
	}

	public void setFISCD_DESCRIPTION(String fISCD_DESCRIPTION) {
		FISCD_DESCRIPTION = fISCD_DESCRIPTION;
	}

	@JsonProperty("FISCD_SCREEN_NAME")
	public String getFISCD_SCREEN_NAME() {
		return FISCD_SCREEN_NAME;
	}

	public void setFISCD_SCREEN_NAME(String fISCD_SCREEN_NAME) {
		FISCD_SCREEN_NAME = fISCD_SCREEN_NAME;
	}

	@JsonProperty("FISCD_FUNCTIONAL_NAME")
	public String getFISCD_FUNCTIONAL_NAME() {
		return FISCD_FUNCTIONAL_NAME;
	}

	public void setFISCD_FUNCTIONAL_NAME(String fISCD_FUNCTIONAL_NAME) {
		FISCD_FUNCTIONAL_NAME = fISCD_FUNCTIONAL_NAME;
	}

	@JsonProperty("AE_TAG")
	public String getCLIENT_AE_TAG() {
		return CLIENT_AE_TAG;
	}

	public void setCLIENT_AE_TAG(String cLIENT_AE_TAG) {
		CLIENT_AE_TAG = cLIENT_AE_TAG;
	}

	@JsonProperty("AE_FIELD")
	public String getCLIENT_AE_FIELD() {
		return CLIENT_AE_FIELD;
	}

	public void setCLIENT_AE_FIELD(String cLIENT_AE_FIELD) {
		CLIENT_AE_FIELD = cLIENT_AE_FIELD;
	}

	@JsonProperty("AE_DESCRIPTION")
	public String getCLIENT_AE_DESCRIPTION() {
		return CLIENT_AE_DESCRIPTION;
	}

	public void setCLIENT_AE_DESCRIPTION(String cLIENT_AE_DESCRIPTION) {
		CLIENT_AE_DESCRIPTION = cLIENT_AE_DESCRIPTION;
	}
