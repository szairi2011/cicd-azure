...
app.get ("/user",(req,res) =>{
    ...
    req.session.tokenSet = passport.deserializeUser.tokenSet;
    console.log('The session TokenSet', req.session.tokenSet);
    console.log('The session UserInfo', req.session.userinfo);
    
    res.end(JSON.stringify({tokenset:req.session.tokenSet,userinfo:req.session.userinfo}));
    // res.end(JSON.stringify({test:'aString'}));
